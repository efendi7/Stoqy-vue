    ...
    <Modal :show="show" @close="$emit('close')" :closeable="!isDeleting">
        <div class="p-6 text-center">
            ...
            <div class="mt-4">
                ...
                <div v-if="supplier" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    <p>Apakah Anda yakin ingin menghapus supplier</p>
                    <p class="font-semibold text-gray-800 dark:text-gray-200 mt-1">"{{ supplier.name }}"?</p>
